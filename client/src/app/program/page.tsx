      ...
      <div className='flex gap-3 flex-col md:flex-row relative'>
        ...
        <div className='md:w-[80%] flex flex-col gap-6'>
          ...
          <section id='1' data-section='1'>
            ...
            <Tabs items={data.requirements.map((requirement) => (
              {
                label: requirement.language,
                key: requirement.id,
                children: requirement.requirements.map((item, index)=>
                  <div className='bg-secondary rounded-2xl flex flex-col md:flex-row justify-between md:justify-start gap-2 p-4' key={index}>
                    <span className='text-[#5a5a5a] leading-5 md:w-1/2'>{item.title}</span>
