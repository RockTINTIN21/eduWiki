	...
	return (
		<div className="text-white relative bg-black ">
			...
			<div className="relative md:pt-60 pt-30">
				...
				<div
					className="relative p-8 flex gap-3 flex-col mx-4 md:w-[1260px] md:mx-auto backdrop-blur-md
        bg-gray-800/50 rounded-4xl"
				>
					<h1 className="md:text-4xl leading-7 md:leading-10 md:w-1/2 pe-16 text-2xl font-medium">
						Все, что стоит делать, стоит делать за границей своих привычных
						горизонтов.
					</h1>

					<span className="italic md:text-2xl text-xl font-light md:pb-30">
						Жюль Верн
					</span>

					<Image
						src="/images/promo/julesGabriel.png"
						alt={"Жюль Верн"}
						loading={"eager"}
						width={750}
						height={500}
				...
				<div className="mx-4 mt-8 pb-12 md:flex md:w-[1260px] md:mx-auto md:gap-4">
					{isMobile ? (
						<MobileCarousel data={shortCards} />
					) : (
				...
				<div className="relative mx-4 md:w-[1260px] md:mx-auto pt-6 z-20 flex flex-col gap-8">
						...
						<div className="flex flex-col gap-4 md:flex-row pt-6">
							<div className="bg-primary rounded-4xl p-8 md:w-1/2 relative">
								...
								<p className="leading-6 text-lg md:w-8/12">
									...
									через получение образования за границей. Мы объединяем
									ключевую информацию о странах, программах и требованиях в
									одном месте, делая процесс подготовки прозрачным и
									структурированным.
								</p>
								<Image
							...
							<div className="flex flex-col gap-4 md:w-1/2">
								{aboutUs.map((card, index) => (
									<div
										key={index}
										className="bg-gray-800/50 rounded-4xl p-8 relative flex"
									>
										<div className="pe-4">
											<h3 className="font-medium text-2xl pb-2">
												{card.title}
											</h3>
					...
					<div>
						...
						<div className="mt-8 pb-12 md:mx-auto md:gap-8 md:grid md:grid-cols-3">
							{isMobile ? (
								<MobileCarousel isShortCard={false} data={ourAbilities} />
							) : (
			...
			<div className="flex flex-col gap-12 pb-12 bg-black mx-4 md:w-[1260px] md:mx-auto pt-6">
				...
				<div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
					{statistics.map((card, index) => (
						<div
							key={index}
							className="bg-[#0A0A0A] rounded-3xl py-8 flex flex-col gap-4 justify-center items-center"
						>
