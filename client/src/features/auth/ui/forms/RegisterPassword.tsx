						...
						<div>
							...
							<div className="space-y-1 pb-4 px-4 text-[#5A5A5A] text-sm">
								<div className="flex items-center gap-1">
									...
									<span
										className={` ${isTouched || fieldState.error ? (passwordValidationState.length ? "styles.validPassword" : "styles.invalidPassword") : ""}`}
									>
										- Минимум 6 символов
									</span>
								</div>
								...
								<div className="flex items-center gap-1">
									...
									<span
										className={` ${isTouched || fieldState.error ? (passwordValidationState.hasLetter ? "styles.validPassword" : "styles.invalidPassword") : ""}`}
									>
										- Хотя бы 1 буква
									</span>
								</div>
								...
								<div className="flex items-center gap-1">
									...
									<span
										className={` ${isTouched || fieldState.error ? (passwordValidationState.hasDigit ? "styles.validPassword" : "styles.invalidPassword") : ""}`}
									>
										- Хотя бы 1 цифра
									</span>
								</div>
